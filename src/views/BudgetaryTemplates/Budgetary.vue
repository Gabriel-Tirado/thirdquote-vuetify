...
export default {
    ...
    setup() {
        const proposalName = ref('Safety PLC Burner Management System Panel')
        ...
        const panelDescription = ref('Safety Compact GuardLogix-based Burner Management System Panel')
        const systemSummary = ref(
            'Everworks will provide a new Safety Compact GuardLogix-based Burner Management System Panel.'
        )
        const systemDetails = ref('System details and clarifications go here.')
        const objectives = ref([
            'Provide a new NEMA 12-rated BMS control panel',
            'Compact GuardLogix PLC and Safety I/O',
        ])
        const deliverables = ref([
            'Custom engineered, fabricated, and tested control panel (as specified)',
        ...
        const equipmentList = ref([
            'Free-standing single-door enclosure, NEMA 12',
        ...
        const scheduleData = ref([
            ...
            ['', 'Documentation Gathering and Review (Internal)', '4 Days'],
            ['Week 2', 'Control Panel Design Review', '1 Week'],
            ['','Develop HMI Screen Layout', '1 Week'],
            ['Week 3', 'Review Control Panel Design with Customer', '1 Week'],
            ['', 'Review HMI Screens Layout with Customer', '1 Week'],
            ['Week 4 - 12', 'Procure Parts', '6 Weeks'],
            ['', 'Assemble Panels', '3 Weeks'],
            ['Week 13', 'Review FAT Specification with Customer', '1 Week'],
            ['', 'Setup Program Simulation and Panels for FAT', '1 Week'],
            ['Week 14', 'FAT of Control Panels and Program/HMI', '2 Days'],
