...
export default {
    ...
    async setup(){
        ...
        return { mobileBrandSelection, BrandSelection, mobileDrawer, coreDrawer, advDrawer, authDrawer, solutions, image1, image2, title, Login, MicrosoftLogin, Logout, ButtonTypeExists, auth, development, screenWidth, buttonGroup, typeSelected }
    }
}
</script>
